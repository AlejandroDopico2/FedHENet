...
[![PyTorch](https://img.shields.io/badge/PyTorch-%3E%3D1.12-EE4C2C?logo=pytorch&logoColor=white)](https://pytorch.org/)
...
│  │  Local Data  │    │  Local Data  │    │  Local Data  │   Clients   │
│  │  + Extractor │    │  + Extractor │    │  + Extractor │     (N)     │
│  └──────┬───────┘    └──────┬───────┘    └──────┬───────┘              │
│         │                   │                   │                       │
│         │  Encrypted Update (CKKS)              │                       │
│         ▼                   ▼                   ▼                       │
│  ┌─────────────────────────────────────────────────────┐               │
│  │                 📡 MQTT Broker                       │               │
│  │                  (Mosquitto)                         │               │
